...
// int p3 = 0, p5 = 0, p6 = 0;
// int note4[4] = { 0, 0, 0, 0 };
byte seq_pitch[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
byte seq_gate[8] = { 1, 1, 1, 1, 1, 1, 1, 1 };
byte seq_vel[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
    ...
    switch (MIDI.getType()) {
      ...
      case midi::ControlChange:
        switch (MIDI.getData1()) {
          case 11:  //切换四种模式 //change cc maping in modular
          ...
          case 1:  //输出mod转化的CV
            ...
            break;
          case 12:  //切换时钟div //clock_rate setting
            clock_rate = MIDI.getData2() >> 5;
            clock_max = 24 * clock_div / clock_rate;
            break;
          case 13:  //调整bpm 预留 //bpm范围:50-177
            seq_bpm = MIDI.getData2() + 50;
            break;
          case 14:  //调整seq length //length范围:1-16
            seq_length = (MIDI.getData2() >> 6) + 1;
            break;
          case 15:  //调整loop mode //范围0-3
            seq_loopmode = MIDI.getData2() >> 8;
            break;
          case 16:  //调整播放状态 //范围0-3
          ...
          case 47:
          case 48:
            seq_pitch[MIDI.getData1() - 41] = MIDI.getData2() >> 1;
            break;
          case 61:  //seq gate
          case 62:
          case 63:
          ...
          case 67:
          case 68:
            seq_gate[MIDI.getData1() - 41] = MIDI.getData2() >> 9;
            break;
          case 81:  //seq vel
          case 82:
          case 83:
          ...
          case 87:
          case 88:
            seq_vel[MIDI.getData1() - 41] = MIDI.getData2();
            break;
        }
        break;  //ControlChange
    }
